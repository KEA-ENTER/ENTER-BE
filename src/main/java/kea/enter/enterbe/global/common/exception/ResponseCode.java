...
public enum ResponseCode {
    ...
    INVALID_QUESTION_STATE_DELETE("QST-ERR-003", HttpStatus.INTERNAL_SERVER_ERROR, "삭제된 문의사항입니다."),
    INVALID_QUESTION_STATE_COMPLETE("QST-ERR-004", HttpStatus.INTERNAL_SERVER_ERROR, "답변 완료된 문의사항입니다."),
