...
public class LotteryListInfo {
    ...
    @Builder
    public LotteryListInfo(Integer round, String takeDate, String returnDate, long competitionRate, String result) {
        this.round = round;
    ...
    public static LotteryListInfo of(Integer round, String takeDate, String returnDate, long competitionRate, String result) {
        return LotteryListInfo.builder()
            .round(round)
            .takeDate(takeDate)
