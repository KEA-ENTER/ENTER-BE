...
@Getter
@NoArgsConstructor
public class GetAdminPenaltyListResponse {
    ...
    @Builder
    public GetAdminPenaltyListResponse(Long penaltyId, String createdAt, PenaltyReason reason,
    ...
    public static GetAdminPenaltyListResponse of(Long penaltyId, String createdAt, PenaltyReason reason,
        PenaltyLevel level, String etc) {
        return GetAdminPenaltyListResponse.builder()
            .penaltyId(penaltyId)
            .createdAt(createdAt)
            .reason(reason)
            .level(level)
